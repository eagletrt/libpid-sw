...
void setUp(void) {
    ...
    pid_controller_api_init(&pid, 1.0f, 0.1f, 0.01f, 0.1f, 10.0f, NULL, 0);
    pid.set_point = 10.0f;

    /* Initialize PID mode (n_prev_errors = 3) */
    pid_controller_api_init(&pid_controller_api_prev_errors, 1.0f, 0.1f, 0.01f, 0.1f, 10.0f, &arena_instance, 3);
...
void test_pid_initialization_PI(void) {
    ...
    TEST_ASSERT_EQUAL_FLOAT_MESSAGE(0.1f, pid.ki, "Error: the value of ki does not match the expected value of 0.1f");
    TEST_ASSERT_EQUAL_FLOAT_MESSAGE(0.01f, pid.kd, "Error: the value of kd does not match the expected value of 0.01f");
    TEST_ASSERT_EQUAL_FLOAT_MESSAGE(0.1f, pid.sample_time, "Error: the value of sample_time does not match the expected value of 0.1f");
    TEST_ASSERT_EQUAL_FLOAT_MESSAGE(10.0f, pid.anti_windUp, "Error: the value of anti_windUp does not match the expected value of 10.0f");
    TEST_ASSERT_EQUAL_FLOAT_MESSAGE(10.0f, pid.set_point, "Error: the value of set_point does not match the expected value of 10.0f");
    TEST_ASSERT_EQUAL_FLOAT_MESSAGE(0.0f, pid.integrator, "Error: the value of integrator does not match the expected value of 0.0f");
    TEST_ASSERT_EQUAL_FLOAT_MESSAGE(0.0f, pid.error, "Error: the value of error does not match the expected value of 0.0f");
    TEST_ASSERT_EQUAL_PTR_MESSAGE(NULL, pid.prev_errors, "Error: the prev_errors pointer is not NULL");
    TEST_ASSERT_EQUAL_INT_MESSAGE(0, pid.n_prev_errors, "Error: the value of n_prev_errors does not match the expected value of 0");
    TEST_ASSERT_EQUAL_INT_MESSAGE(0, pid.prev_error_index, "Error: the value of prev_error_index does not match the expected value of 0");
}
...
void test_pid_initialization_with_prev_errors(void) {
    ...
    TEST_ASSERT_EQUAL_FLOAT_MESSAGE(0.1f, pid_controller_api_prev_errors.ki, "Error: the value of ki does not match the expected value of 0.1f");
    TEST_ASSERT_EQUAL_FLOAT_MESSAGE(0.01f, pid_controller_api_prev_errors.kd, "Error: the value of kd does not match the expected value of 0.01f");
    TEST_ASSERT_EQUAL_FLOAT_MESSAGE(0.1f, pid_controller_api_prev_errors.sample_time, "Error: the value of sample_time does not match the expected value of 0.1f");
    TEST_ASSERT_EQUAL_FLOAT_MESSAGE(10.0f, pid_controller_api_prev_errors.anti_windUp, "Error: the value of anti_windUp does not match the expected value of 10.0f");
    TEST_ASSERT_EQUAL_FLOAT_MESSAGE(10.0f, pid_controller_api_prev_errors.set_point, "Error: the value of set_point does not match the expected value of 10.0f");
    TEST_ASSERT_EQUAL_FLOAT_MESSAGE(0.0f, pid_controller_api_prev_errors.integrator, "Error: the value of integrator does not match the expected value of 0.0f");

    for (int i = 0; i < pid_controller_api_prev_errors.n_prev_errors; i++) {
        char msg[100];
        sprintf(msg, "Error: prev_errors[%d] does not match the expected value of 0.0f", i);
        TEST_ASSERT_EQUAL_FLOAT_MESSAGE(0.0f, pid_controller_api_prev_errors.prev_errors[i], msg);
    }
}
